...
export const sendResetPasswordMail=async(email:string,otp:string)=>{
    try {
        await mailSender(
            email,
            "Zaid - Password Reset Request",
            `
            <div style="font-family: Arial, sans-serif; color: #333;">
              <h2 style="color: #0a74da;">Password Reset Request</h2>
              <p>Dear user,</p>
              <p>We received a request to reset your password for your <strong>ZAID</strong> account. Please use the OTP code below to reset your password:</p>
