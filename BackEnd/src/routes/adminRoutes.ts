...
//products
router.post('/products',authenticateAdminToken,upload.array('images',4),addProduct)
...
router.put('/products/:_id',authenticateAdminToken,upload.array('images',4),editProduct)
